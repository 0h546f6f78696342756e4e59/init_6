...
# $Header: /var/cvsroot/gentoo-x86/media-sound/pulseaudio/pulseaudio-0.9.22.ebuild,v 1.17 2011/04/26 14:46:37 xarthisius Exp $
...
IUSE="+alsa avahi +caps jack lirc oss tcpd +X dbus libsamplerate gnome bluetooth +asyncns +glib test doc +udev ipv6 system-wide 
realtime"
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-0.9.22-fix-build-on-git-xcb-util.patch"
