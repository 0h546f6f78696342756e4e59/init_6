...
pkg_setup() {
	local extensions=""
	extensions="actions adblock auto-reload auto-scroller \
			    certificates extensions-manager-ui \
			    greasemonkey gestures html5tube \
			    push-scroller soup-fly tab-groups \
			    tab-key-tab-navigate tab-states rss"
