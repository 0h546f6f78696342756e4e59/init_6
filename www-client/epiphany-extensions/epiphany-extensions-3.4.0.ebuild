...
RDEPEND=">=www-client/epiphany-3.4.0
	app-text/opensp
...
pkg_setup() {
	...
	# auto-scroller, permissions  build failed
	extensions="actions adblock auto-reload \
			certificates error-viewer extensions-manager-ui \
			gestures java-console livehttpheaders page-info \
