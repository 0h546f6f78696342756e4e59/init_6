...
#	epatch "${FILESDIR}"/"${PVR}"/git-linus.diff #zero
...
#	epatch "${FILESDIR}"/"${PVR}"/linux-2.6-upstream-reverts.patch -R #zero
...
# Assorted Virt Fixes
	...
	epatch "${FILESDIR}"/"${PVR}"/xen-blkfront-name-adjust.patch
...
#	epatch "${FILESDIR}"/"${PVR}"/fix-cdc-ncm-dma-stack-vars.patch
