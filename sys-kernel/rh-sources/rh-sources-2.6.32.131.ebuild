...
SRC_URI="${SRC_URI_PREFIX}/6Client/en/os/SRPMS/kernel-2.6.32-131.0.15.el6.src.rpm
	${SRC_URI_PREFIX}/6ComputeNode/en/os/SRPMS/kernel-2.6.32-131.0.15.el6.src.rpm
	${SRC_URI_PREFIX}/6Server/en/os/SRPMS/kernel-2.6.32-131.0.15.el6.src.rpm
	${SRC_URI_PREFIX}/6Workstation/en/os/SRPMS/kernel-2.6.32-131.0.15.el6.src.rpm"
